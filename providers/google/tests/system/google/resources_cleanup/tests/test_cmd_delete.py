...
from airflow_google_provider_resource_cleanup.commands.cmd_delete import check_min_age, handle_asset_type, handle_delete
...
def handle_delete_dependencies():
    ...
    mock_provide_tp = MagicMock()
    mock_get_tp_item = MagicMock()
    ...
    return {
        ...
        "provide_tp_asset_resource_file_fn": mock_provide_tp,
        "get_resources_file_fn": mock_get_file,
        "load_json_fn": mock_load_json,
        "get_tp_asset_data_item_fn": mock_get_tp_item,
