...
class DeleteFeatureViewOperator(GoogleCloudBaseOperator, OperationHelper):
    ...
    def execute(self, context: Context) -> dict[str, Any]:
        ...
        self.log.info("Deleting the Feature View %s ... ", self.feature_online_store_id)
        ...
        self.wait_for_operation_result(operation=result_operation)
        self.log.info("The Feature View deletion has been complete: %s", self.feature_online_store_id)
