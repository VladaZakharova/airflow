...
.. _howto/operator:DeleteKubernetesJobOperator:

DeleteKubernetesJobOperator
===========================

The :class:`~airflow.providers.cncf.kubernetes.operators.job.DeleteKubernetesJobOperator` allows
