...
class GKEBaseOperator(GoogleCloudBaseOperator):
    """
    Base class for all GKE operators.
...
class GKEDeleteClusterOperator(GKEBaseOperator):
    """
    ...
    **Operator Creation**: ::
    ...
    template_fields: Sequence[str] = tuple(
        {"api_version", "deferrable", "poll_interval"} | set(GKEBaseOperator.template_fields)
    )
...
class GKECreateClusterOperator(GKEBaseOperator):
    """
    ...
    **Operator Creation**: ::
    ...
    template_fields: Sequence[str] = tuple(
        {"body", "api_version", "deferrable", "poll_interval"} | set(GKEBaseOperator.template_fields)
    )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs["cluster_name"] = body["name"] if isinstance(body, dict) else body.name
        super().__init__(*args, **kwargs)
...
class GKEStartKueueInsideClusterOperator(GKEBaseOperator, KubernetesInstallKueueOperator):
    """
    ...
    template_fields = tuple(
        set(GKEBaseOperator.template_fields) | set(KubernetesInstallKueueOperator.template_fields)
    )
    operator_extra_links = (KubernetesEngineClusterLink(),)
...
class GKEStartPodOperator(GKEBaseOperator, KubernetesPodOperator):
    """
...
class GKEStartJobOperator(GKEBaseOperator, KubernetesJobOperator):
    """
...
class GKEDescribeJobOperator(GKEBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple({"job_name", "namespace"} | set(GKEBaseOperator.template_fields))
    operator_extra_links = (KubernetesEngineJobLink(),)
...
class GKEListJobsOperator(GKEBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple({"namespace"} | set(GKEBaseOperator.template_fields))
...
class GKECreateCustomResourceOperator(GKEBaseOperator, KubernetesCreateResourceOperator):
    """
    ...
    template_fields: Sequence[str] = tuple(
        set(GKEBaseOperator.template_fields) | set(KubernetesCreateResourceOperator.template_fields)
    )
...
class GKEDeleteCustomResourceOperator(GKEBaseOperator, KubernetesDeleteResourceOperator):
    """
    ...
    template_fields: Sequence[str] = tuple(
        set(GKEBaseOperator.template_fields) | set(KubernetesDeleteResourceOperator.template_fields)
    )
...
class GKEStartKueueJobOperator(GKEBaseOperator, KubernetesStartKueueJobOperator):
    """Executes a Kubernetes Job in Kueue in the specified Google Kubernetes Engine cluster."""

    template_fields = tuple(
        set(GKEBaseOperator.template_fields) | set(KubernetesStartKueueJobOperator.template_fields)
    )


class GKEDeleteJobOperator(GKEBaseOperator, KubernetesDeleteJobOperator):
    """
    ...
    template_fields: Sequence[str] = tuple(
        set(GKEBaseOperator.template_fields) | set(KubernetesDeleteJobOperator.template_fields)
    )
...
class GKESuspendJobOperator(GKEBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple({"name", "namespace"} | set(GKEBaseOperator.template_fields))
    operator_extra_links = (KubernetesEngineJobLink(),)

    def __init__(self, name: str, namespace: str, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
...
class GKEResumeJobOperator(GKEBaseOperator):
    """
