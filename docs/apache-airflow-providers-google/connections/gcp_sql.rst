...
Configuring and using IAM authefication
---------------------------------------
...
the ``gcloud`` authentication or an another account. If you desided to use a different account then this
...
Here is a links what should be done before the start:
