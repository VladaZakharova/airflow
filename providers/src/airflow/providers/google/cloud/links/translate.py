...
class TranslateResultByOutputConfigLink(BaseGoogleLink):
    """
    Helper class for constructing Translation results by provided output_config with gcs destination
    specified.

    Provides link to gcs destination output translation results.
    """
