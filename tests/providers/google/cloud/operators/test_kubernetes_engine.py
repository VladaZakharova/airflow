...
DEL_KUB_JOB_OPERATOR_EXEC = (
    "airflow.providers.cncf.kubernetes.operators.job.DeleteKubernetesJobOperator.execute"
)
...
class TestGKEDeleteJobOperator:
    ...
    def test_template_fields(self):
        assert set(DeleteKubernetesJobOperator.template_fields).issubset(GKEDeleteJobOperator.template_fields)
