...
class DagFileProcessorManager(LoggingMixin):
    ...
    def _log_file_processing_stats(self, known_file_paths):
        ...
        # Last # Of DB Queries: The last number of queries performed to the
        # Airflow database during parsing of file
        headers = [
            "File Path",
            "PID",
            "Runtime",
    ...
    def get_last_num_of_db_queries(self, file_path) -> int | None:
        """
        Retrieve the last number of queries performed to the Airflow database during parsing of file.

        :param file_path: the path to the file that was processed
        :return: the last number of queries performed to the Airflow database during parsing of file,
