...
with DAG(
    "example_beam_native_go_deferrable",
    ...
    wait_for_go_job_async_job_message_deferrable = DataflowJobMessagesSensor(
        task_id="wait_for_go_job_async_message_deferrable",
        job_id="{{task_instance.xcom_pull('start_go_pipeline_dataflow_runner')['dataflow_job_id']}}",
        location=LOCATION,
    ...
    wait_for_go_job_async_autoscaling_event_deferrable = DataflowJobAutoScalingEventsSensor(
        task_id="wait_for_go_job_async_autoscaling_event_deferrable",
        job_id="{{task_instance.xcom_pull('start_go_pipeline_dataflow_runner')['dataflow_job_id']}}",
        location=LOCATION,
    ...
    (
        ...
        >> [
            ...
            wait_for_go_job_async_job_message_deferrable,
            wait_for_go_job_async_autoscaling_event_deferrable,
        ]
        # TEST TEARDOWN
        >> delete_bucket
    )
