...
class GoogleSheetsCreateSpreadsheetOperator(BaseOperator):
    ...
    :param drive_id: Shared drive id where user want to store spreadsheet. In case when user want to use the operator
        with service account. Modern Google Security Policy restricts having storage space on SA.
