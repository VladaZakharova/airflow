...
# genai = pytest.importorskip("vertexai.generative_models")

from airflow.exceptions import AirflowProviderDeprecationWarning
from airflow.providers.google.cloud.operators.gen_ai.generative_model import (
...
class TestGenAIGenerateEmbeddingsOperator:
    @mock.patch(GEN_AI_PATH.format("generative_model.GenAIGenerativeModelHook"))
