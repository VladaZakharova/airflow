...
class CloudRunPythonJobImageBuilder:
    ...
    def _download_python_file(self, destination_path: Path) -> None:
        ...
        if not self.python_file.startswith("gs://"):  # type: ignore[union-attr]
        ...
        without_scheme = self.python_file[len("gs://") :]  # type: ignore[index]
        try:
    ...
    def get_python_source(self) -> str:
        ...
        return textwrap.dedent(inspect.getsource(self.python_callable))  # type: ignore[arg-type]
