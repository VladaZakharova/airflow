...
APACHE_KAFKA_STRING = "airflow.providers.google.cloud.hooks.apache_kafka.{}"


class TestApacheKafkaWithDefaultProjectIdHook:
    def setup_method(self):
        with mock.patch(
            BASE_STRING.format("GoogleBaseHook.__init__"), new=mock_base_gcp_hook_default_project_id
        ):
            self.hook = ApacheKafkaHook(gcp_conn_id=TEST_GCP_CONN_ID)

    @mock.patch(APACHE_KAFKA_STRING.format("ApacheKafkaHook.get_managed_kafka_client"))
...
class TestApacheKafkaWithoutDefaultProjectIdHook:
    def setup_method(self):
        with mock.patch(
