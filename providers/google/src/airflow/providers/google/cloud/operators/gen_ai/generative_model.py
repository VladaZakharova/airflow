...
from airflow.providers.google.cloud.hooks.gen_ai.generative_model import (
...
class GenAIGenerateEmbeddingsOperator(GoogleCloudBaseOperator):
    ...
    def __init__(
        ...
        *,
        ...
        location: str,
        model: str,
        contents: ContentListUnion | ContentListUnionDict | [str],
...
class GenAISupervisedFineTuningTrainOperator(GoogleCloudBaseOperator):
    ...
    def __init__(
        ...
        *,
        ...
        tuning_job_config: CreateTuningJobConfigOrDict | None = None,
        gcp_conn_id: str = "google_cloud_default",
        impersonation_chain: str | Sequence[str] | None = None,
        **kwargs,
    ) -> None:
    ...
    def execute(self, context: Context):
        ...
        self.log.info("Tuned Model EndpointName: %s", response.tuned_model.endpoint)

        context["ti"].xcom_push(key="tuned_model_name", value=response.tuned_model.model)
        context["ti"].xcom_push(key="tuned_model_endpoint_name", value=response.tuned_model.endpoint)

        result = {
            "tuned_model_name": response.tuned_model.model,
