...
from airflow.providers.google.cloud.hooks.apache_kafka import ApacheKafkaHook
...
class ApacheKafkaBaseOperator(GoogleCloudBaseOperator):
    """
    Base class for Apache Kafka operators.
    ...
    @cached_property
    def hook(self) -> ApacheKafkaHook:
        return ApacheKafkaHook(
            gcp_conn_id=self.gcp_conn_id,
            impersonation_chain=self.impersonation_chain,
        )


class ApacheKafkaCreateClusterOperator(ApacheKafkaBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple(
        {"cluster", "cluster_id"} | set(ApacheKafkaBaseOperator.template_fields)
    )
...
class ApacheKafkaListClustersOperator(ApacheKafkaBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple({"page_token"} | set(ApacheKafkaBaseOperator.template_fields))
...
class ApacheKafkaGetClusterOperator(ApacheKafkaBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple({"cluster_id"} | set(ApacheKafkaBaseOperator.template_fields))
    operator_extra_links = (ApacheKafkaClusterLink(),)
...
class ApacheKafkaUpdateClusterOperator(ApacheKafkaBaseOperator):
    """
    ...
    template_fields: Sequence[str] = tuple(
        {"cluster_id", "cluster", "update_mask"} | set(ApacheKafkaBaseOperator.template_fields)
    )
    operator_extra_links = (ApacheKafkaClusterLink(),)
...
class ApacheKafkaDeleteClusterOperator(ApacheKafkaBaseOperator):
    """
